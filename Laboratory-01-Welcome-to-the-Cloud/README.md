...
## Skills Learned
- How to create and manage a new user account in Linux using sudo
- How to gather system information such as OS version, kernel, CPU, memory, and disk space
- How to create folders and files using ubuntu terminal
- How to write and edit Markdown files using nano
- How to create and structure a professional portfolio repository on GitHub
